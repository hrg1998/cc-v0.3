...
//        }
        ...
        formMetaData = FormMetaData(
            ...
            uid= fingerprint ,
            id_site = idSite,
            fieldsMetaData = resultFieldMetaData,
...
//                        }
    ...
    override fun setContentView(view: View) {
        ...
        this.view = view
        if (this.view is ViewGroup) (this.view as ViewGroup).addView(focusView, 0)

        this.bitaApplicationContext = applicationContext
    ...
    override fun setContentView(layoutResID: Int) {
        ...
        this.view = findViewById<ViewGroup>(android.R.id.content).rootView
        (view as ViewGroup).addView(focusView, 0)
        this.bitaApplicationContext = applicationContext
        this.deviceId = getDeviceId()
        this.fingerprint=getFingerPrint()
        this.resolution = getResolution()
