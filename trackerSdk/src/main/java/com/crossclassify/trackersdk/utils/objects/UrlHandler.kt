...
object UrlHandler {
    ...
    fun generateNewFormUrl(formMetaData: FormMetaData, formName: String): String {
        ...
        return "matomo.php?action_name=formAutoGenerate" +
                "&idsite=${formMetaData.id_site}&rec=1&r=511664&h=$hour&m=$minutes&s=$seconds" +
                "&url=$formName" +
                "&_id=${formMetaData._id}&_idn=0&_refts=0&send_image=0&pdf=1&qt=0&realp=0&wma=0&fla=0&java=0&ag=0&cookie=1&res=${formMetaData.resolustion}&fa_pv=1" +
